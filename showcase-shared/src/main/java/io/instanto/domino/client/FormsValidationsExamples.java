...
public final class FormsValidationsExamples implements org.dominokit.domino.ui.style.DominoCss {
  ...
  public HTMLDivElement render() {
    ...
    element.appendChild(readOnlyCard);
    return element.element();
  }

  private void initHelperText() {
    element.appendChild(
        Card.create("HELPER TEXTS")
            .appendChild(BlockHeader.create("Text Box"))
            .appendChild(
                TextBox.create("Task Name").setHelperText("Each task should have unique name."))
            .appendChild(br())
            ...
            .appendChild(
                Select.<String>create("Task type")
            ...
            .appendChild(
                CheckBox.create("I want to receive an news about this task")
                    .setHelperText("news will be sent via email"))
            .appendChild(br())
            .appendChild(BlockHeader.create("Radio"))
            .appendChild(
                RadioGroup.<String>create("estimation", "Estimation")
                            ...
                            self1.appendChild(
                                PostfixAddOn.of(
                                    Icons.eye_off()
                                        ...
                                        .addEventListener(
                                            "mousedown",
                                            evt1 -> self1.getInputElement().element().type = "text")
                                        .addEventListener(
                                            "mouseup",
                                            evt1 ->
                                                self1.getInputElement().element().type =
                                                    "password")))))
            .appendChild(
                TextAreaBox.create("Description")
                    .appendChild(PrefixAddOn.of(Icons.note()))
                    .appendChild(PostfixAddOn.of(Icons.text())))
            .appendChild(
                Select.<String>create("Language")
                    .appendChild(PrefixAddOn.of(Icons.earth()))
                    .appendChild(
                        PostfixAddOn.of(
                            Icons.information()
                                .setTooltip(
                                    "All system pages will be shown in the selected language",
                                    DropDirection.BEST_SIDE_UP_DOWN)))
  ...
  private void initWordCount() {
    countsCard
        .appendChild(TextBox.create("Name").setMaxLength(10))
  ...
  private void initValidations() {
    ...
    validationsCard
        .appendChild(
            Row.create()
                .appendChild(
                    Column.span12().appendChild(TextBox.create("Name").groupBy(fieldsGrouping))))
        .appendChild(
            Row.create()
                .appendChild(
                    Column.span12()
                        .appendChild(TextBox.create("Surename").groupBy(fieldsGrouping))))
        .appendChild(
            Row.create()
                .appendChild(
                    Column.span12().appendChild(TextBox.create("Email").groupBy(fieldsGrouping))))
        .appendChild(
            Row.create()
                .appendChild(
                    Column.span12()
                        .appendChild(
                            RadioGroup.<String>create("gender", "Gender")
        ...
        .appendChild(
            Row.create()
                .appendChild(
                    Column.span12()
                        .appendChild(
                            CheckBox.create("I have read and accept the terms")
                                .groupBy(fieldsGrouping))))
        .appendChild(
            Row.create()
                .appendChild(
  ...
  private void initReadOnly() {
    readOnlyCard.appendChild(
        Row.create()
            .appendChild(
                Column.span12()
                    .appendChild(TextBox.create("TextBox").withValue("Mr. Joan").setReadOnly(true)))
            .appendChild(
                Column.span12()
                    .appendChild(
                        TextAreaBox.create("TextArea")
            ...
            .appendChild(
                Column.span12()
                    .appendChild(
                        SwitchButton.create().setOffTitle("Required").check().setReadOnly(true)))
            .appendChild(
                Column.span12()
                    .appendChild(SwitchButton.create("Required", "Yes", "No").setReadOnly(true)))
            .appendChild(
                Column.span12()
                    .appendChild(CheckBox.create("Readonly checkbox").check().setReadOnly(true)))
            .appendChild(
                Column.span12()
                    .appendChild(CheckBox.create("Readonly checkbox").setReadOnly(true))));
  }
}
