...
public final class TreeExamples implements org.dominokit.domino.ui.style.DominoCss {
  ...
  private void simpleTree() {
    Tree<String> hardwareTree =
        Tree.<String>create("HARDWARE")
            .addSelectionListener(
                (treeItem, selection) -> DomGlobal.console.info(treeItem.get().getValue()))
            .appendChild(
  ...
  private void nestedTree() {
    Tree<String> hardwareTree =
        Tree.<String>create("HARDWARE")
            .appendChild(
                TreeItem.create(Icons.desktop_classic(), "Computer")
                    .addClickListener(evt -> Notification.create("Computer").show())
                    .appendChild(
                        TreeItem.create(Icons.headset(), "Headset")
                            .addClickListener(evt -> Notification.create("Headset").show()))
            ...
            .appendChild(
                TreeItem.create(Icons.laptop(), "Laptop")
                    .addClickListener(evt -> Notification.create("Laptop").show())
                    .appendChild(
                        TreeItem.create(Icons.laptop(), "Chromebook")
                            .addClickListener(evt -> Notification.create("Chromebook").show()))
                    .appendChild(
                        TreeItem.create(Icons.laptop_account(), "MacBook")
                ...
                TreeItem.create(Icons.cellphone(), "Smart phone")
                    ...
                    .appendChild(
                        TreeItem.create(Icons.tablet(), "Tablet")
                            .addClickListener(evt -> Notification.create("Tablet").show()))
                    .appendChild(
                        TreeItem.create(Icons.cellphone(), "Android")
                            .addClickListener(evt -> Notification.create("Android").show()))
                    .appendChild(
                        TreeItem.create(Icons.cellphone_cog(), "iPhone")
                            .addClickListener(evt -> Notification.create("iPhone").show())));

    Tree<String> hardwareMenu2 =
        Tree.<String>create("FILES")
            .setToggleTarget(ToggleTarget.ICON)
            ...
            .appendChild(
                TreeItem.create(Icons.folder(), "Folder")
                    .appendChild(
                        TreeItem.create(Icons.folder_star(), "My files")
                            .appendChild(
                                TreeItem.create(Icons.note(), "File 1")
                                    .addClickListener(evt -> Notification.create("File 1").show()))
                            .appendChild(
                                TreeItem.create(Icons.note(), "File 2")
                                    .addClickListener(evt -> Notification.create("File 2").show()))
                            .appendChild(
                                (TreeItem.create(Icons.note(), "File 3"))
                                    .addClickListener(evt -> Notification.create("File 3").show()))
                            .appendChild(
                                TreeItem.create(Icons.note(), "File 4")
    ...
    element.appendChild(
        Card.create("SIMPLE NESTED MENU")
            .appendChild(
                Row.create()
                    .appendChild(
                        Column.span6()
  ...
  private void activeAndExpandIcons() {
    ...
    Tree<String> citiesTree =
        Tree.<String>create("CITIES")
            .setFilter(
            ...
            .apply(
                tree -> {
                  countries.forEach(
                      country -> {
                        tree.appendChild(
                            TreeItem.<String>create(Icons.map(), country.getName())
                                .apply(
                                    countryItem -> {
                                      countryItem
                                          .appendChild(
                                          ...
                                          .appendChild(
                                              PostfixAddOn.of(
                                                  ToggleMdiIcon.create(Icons.plus(), Icons.minus())
                                                      .apply(
                                                          icon -> {
                                                            countryItem
                                          ...
                                          .forEach(
                                              city ->
                                                  countryItem.appendChild(
                                                      TreeItem.create(Icons.city(), city)));
                                    }));
                      });
                });

    Tree<String> foldersExpand =
        Tree.<String>create("FILES")
            .setAutoCollapse(false)
            .setFoldable(true)
            .setSearchable(true)
            ...
            .appendChild(
                TreeItem.create("Folder 1")
                    .appendChild(
                        TreeItem.create("Folder 1-1")
                    ...
                    .appendChild(
                        TreeItem.create("Folder 1-2")
                            .appendChild(TreeItem.create("File 1"))
                            .appendChild(TreeItem.create("File 2"))
                            .appendChild(TreeItem.create("File 3"))
                            .appendChild(TreeItem.create("File 4"))))
            .appendChild(
                TreeItem.create("Folder 2")
                    .appendChild(
                        TreeItem.create("Folder 2-1")
                            .appendChild(TreeItem.create("File 1"))
                            .appendChild(TreeItem.create("File 2"))
                            .appendChild(TreeItem.create("File 3"))
                            .appendChild(TreeItem.create("File 4")))
                    .appendChild(
                        TreeItem.create("Folder 2-2")
                            .appendChild(TreeItem.create("File 1"))
                            .appendChild(TreeItem.create("File 2"))
                            .appendChild(TreeItem.create("File 3"))
                            .appendChild(TreeItem.create("File 4"))))
            .appendChild(
                TreeItem.create("Folder 3")
                    .appendChild(
                        TreeItem.create("Folder 3-1")
                            .appendChild(TreeItem.create("File 1"))
                            .appendChild(TreeItem.create("File 2"))
                            .appendChild(TreeItem.create("File 3"))
                            .appendChild(TreeItem.create("File 4"))
    ...
    element.appendChild(
        Card.create("ACTIVE/EXPAND ICONS, SEARCH & FOLDING")
            .appendChild(
                Row.create()
                    .appendChild(
                        Column.span6()
