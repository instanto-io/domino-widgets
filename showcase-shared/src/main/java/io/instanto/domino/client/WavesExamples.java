    ...
    element.appendChild(
        Row.create()
            .appendChild(
                Column.span6()
                    .appendChild(
                        Card.create("COLOR VARIATIONS")
                            .appendChild(
                                ListGroup.<IsElement<?>>create()
                                    .setSelectable(false)
                                    .setItemRenderer(
                                        (listGroup, listItem) ->
                                            listItem
                                    ...
                                    .setItems(
                                        Arrays.asList(
                                            ...
                                            div()
                                                ...
                                                .appendChild(
                                                    div()
                                                        .addCss(dui_grow_1, dui_fg_accent)
                                            ...
                                            div()
                                                ...
                                                .appendChild(
                                                    div()
                                                        .addCss(dui_grow_1, dui_fg_purple)
                                            ...
                                            div()
                                                ...
                                                .appendChild(
                                                    div()
                                                        .addCss(dui_grow_1, dui_fg_deep_purple)
                                                                ...
                                                                .withWaves(
                                                                    wavesSupport ->
                                                                        wavesSupport
                                                                            .getElement()
                                                                            .addCss(
                                                                                dui_waves_deep_purple)))),
                                            div()
                                                .addCss(dui_flex)
                                                .addCss(dui_items_center)
                                                .appendChild(
                                                    div()
                                                        .addCss(dui_grow_1, dui_fg_indigo)
                                            ...
                                            div()
                                                ...
                                                .appendChild(
                                                    div()
                                                        .addCss(dui_grow_1, dui_fg_light_blue)
                                                                ...
                                                                .withWaves(
                                                                    wavesSupport ->
                                                                        wavesSupport
                                                                            .getElement()
                                                                            .addCss(
                                                                                dui_waves_light_blue)))),
                                            div()
                                                .addCss(dui_flex)
                                                .addCss(dui_items_center)
                                                .appendChild(
                                                    div()
                                                        .addCss(dui_grow_1, dui_fg_cyan)
                                            ...
                                            div()
                                                ...
                                                .appendChild(
                                                    div()
                                                        .addCss(dui_grow_1, dui_fg_green)
                                            ...
                                            div()
                                                ...
                                                .appendChild(
                                                    div()
                                                        .addCss(dui_grow_1, dui_fg_light_green)
                                                                ...
                                                                .withWaves(
                                                                    wavesSupport ->
                                                                        wavesSupport
                                                                            .getElement()
                                                                            .addCss(
                                                                                dui_waves_light_green)))),
                                            div()
                                                .addCss(dui_flex)
                                                .addCss(dui_items_center)
                                                .appendChild(
                                                    div()
                                                        .addCss(dui_grow_1, dui_fg_lime)
                                            ...
                                            div()
                                                ...
                                                .appendChild(
                                                    div()
                                                        .addCss(dui_grow_1, dui_fg_yellow)
                                            ...
                                            div()
                                                ...
                                                .appendChild(
                                                    div()
                                                        .addCss(dui_grow_1, dui_fg_amber)
                                            ...
                                            div()
                                                ...
                                                .appendChild(
                                                    div()
                                                        .addCss(dui_grow_1, dui_fg_orange)
                                            ...
                                            div()
                                                ...
                                                .appendChild(
                                                    div()
                                                        .addCss(dui_grow_1, dui_fg_deep_orange)
                                                                ...
                                                                .withWaves(
                                                                    wavesSupport ->
                                                                        wavesSupport
                                                                            .getElement()
                                                                            .addCss(
                                                                                dui_waves_deep_orange)))),
                                            div()
                                                .addCss(dui_flex)
                                                .addCss(dui_items_center)
                                                .appendChild(
                                                    div()
                                                        .addCss(dui_grow_1, dui_fg_brown)
                                            ...
                                            div()
                                                ...
                                                .appendChild(
                                                    div()
                                                        .addCss(dui_grow_1, dui_fg_blue_grey)
                                            ...
                                            div()
                                                ...
                                                .appendChild(
                                                    div()
                                                        .addCss(dui_grow_1, dui_fg_black)
                                        ...
                                        Arrays.asList(
                                            div()
                                                ...
                                                .appendChild(
                                                    div()
                                                        .appendChild(
                                                            Button.create(Icons.microphone())
                                                                .circle()
                                                                .withWaves())),
                                            div()
                                                .addCss(dui_flex)
                                            ...
                                            div()
                                                ...
                                                .appendChild(
                                                    div()
                                                        .appendChild(
                                                            Button.create(Icons.aspect_ratio())
                                                                .circle()
                                                                .withWaves(
                                                                    wavesSupport ->
                                                                        wavesSupport
                                            ...
                                            div()
                                                ...
                                                .appendChild(
                                                    div()
                                                        .appendChild(
                                                            Button.create(Icons.location_enter())
                                                                .circle()
                                                                .withWaves(
                                                                    wavesSupport ->
                                                                        wavesSupport
                                            ...
                                            div()
                                                ...
                                                .appendChild(
                                                    div()
                                                        .appendChild(
                                                            Button.create(Icons.book_remove())
                                                                .circle()
                                                                .withWaves(
                                                                    wavesSupport ->
                                                                        wavesSupport
