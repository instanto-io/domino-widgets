    ...
    this.root
        .appendChild(
            createAction(
                "Condense",
                "Expand",
                Icons.arrow_collapse_vertical(),
                Icons.arrow_expand_vertical(),
                () -> dataTable.setCondensed(true),
                () -> dataTable.setCondensed(false),
                dataTable::isCondensed))
        .appendChild(
            createAction(
                "No Stripes",
                "Stripped",
                Icons.view_day_outline(),
                Icons.view_day(),
                () -> dataTable.setStriped(true),
                () -> dataTable.setStriped(false),
                dataTable::isStriped))
        .appendChild(
            createAction(
                "No Borders",
                ...
                Icons.border_none(),
                () -> dataTable.setBordered(true),
                () -> dataTable.setBordered(false),
                dataTable::isBordered))
        .appendChild(
            createAction(
                "No Hover",
                "Hovered",
                Icons.blur_off(),
                Icons.blur(),
                () -> dataTable.setHover(false),
                () -> dataTable.setHover(true),
                () -> !dataTable.isHover()));
  }

  private ToggleMdiIcon createAction(
      String initialTooltip,
      String toggeledTooltip,
      MdiIcon initialIcon,
      MdiIcon toggeledIcon,
      Action initialAction,
      Action toggeledAction,
      Condition condition) {
