...
public final class NotificationsExamples implements org.dominokit.domino.ui.style.DominoCss {
  ...
  private void notificationsPosition() {
    ...
    element.appendChild(
        Card.create("NOTIFICATION POSITIONS")
            .appendChild(
                Row.create()
                        ...
                        .appendChild(
                            div()
                                ...
                                .appendChild(
                                    span()
                                        .textContent(
                                            "Invalid action, please try something else.!")))
                        .show());

    Button success =
        Button.create("SUCCESS")
                    ...
                    Notification.create()
                        ...
                        .appendChild(
                            div()
                                ...
                                .appendChild(
                                    span().textContent("Operation completed successfully.")))
                        .show());

    Button warning =
        Button.create("WARNING")
                    ...
                    Notification.create()
                        ...
                        .appendChild(
                            div()
                                ...
                                .appendChild(
                                    span().textContent("Operation completed with warnings."))
                                .appendChild(
                                    Badge.create("15")
                    ...
                    Notification.create()
                        ...
                        .appendChild(
                            div()
                                ...
                                .appendChild(
                                    span().textContent("Follow up ID generated, click to copy."))
                                .appendChild(
                                    Badge.create("123456789")
                                        .addCss(dui_bg_d_2, dui_fg, dui_rounded_full))
                                .appendChild(Icons.content_copy().clickable()))
                        .show());

    element.appendChild(
        Card.create("NOTIFICATION TYPES", "Use predefined notification styles.")
            .appendChild(
                Row.create()
  ...
  private void withMaterialColors() {
    ...
    Button blueGreyButton =
        Button.create("BLUE GREY")
    ...
    Button deepOrangeButton =
        Button.create("DEEP ORANGE")
    ...
    element.appendChild(
        Card.create("WITH MATERIAL DESIGN COLORS")
            .appendChild(
                Row.create()
  ...
  private void withAnimation() {
    ...
    Button fadeInOutLeft =
        Button.create("FADE IN OU LEFT")
            .addCss(dui_pink, dui_w_full)
            .addClickListener(
                e ->
                    Notification.create("You received a message")
    ...
    Button fadeInOutRight =
        Button.create("FADE IN OUT RIGHT")
            .addCss(dui_pink, dui_w_full)
            .addClickListener(
                e ->
                    Notification.create("You received a message")
    ...
    Button fadeInOutDown =
        Button.create("FADE IN OUT DOWN")
            .addCss(dui_pink, dui_w_full)
            .addClickListener(
                e ->
                    Notification.create("You received a message")
    ...
    Button bounceInOutLeft =
        Button.create("BOUNCE IN OUT LEFT")
            .addCss(dui_cyan, dui_w_full)
            .addClickListener(
                e ->
                    Notification.create("You received a message")
    ...
    Button bounceInOutRight =
        Button.create("BOUNCE IN OUT RIGHT")
            .addCss(dui_cyan, dui_w_full)
            .addClickListener(
                e ->
                    Notification.create("You received a message")
    ...
    Button bounceInOutUp =
        Button.create("BOUNCE IN OUT UP")
            .addCss(dui_cyan, dui_w_full)
            .addClickListener(
                e ->
                    Notification.create("You received a message")
    ...
    Button bounceInOutDown =
        Button.create("BOUNCE IN OUT DOWN")
            .addCss(dui_cyan, dui_w_full)
            .addClickListener(
                e ->
                    Notification.create("You received a message")
    ...
    Button rotateInOutUpLeft =
        Button.create("ROTATE IN OUT UP LEFT")
            .addCss(dui_light_green, dui_w_full)
            .addClickListener(
                e ->
                    Notification.create("You received a message")
    ...
    Button rotateInOutUpRight =
        Button.create("ROTATE IN OUT UP RIGHT")
            .addCss(dui_light_green, dui_w_full)
            .addClickListener(
                e ->
                    Notification.create("You received a message")
    ...
    Button rotateInOutDownLeft =
        Button.create("ROTATE IN OUT DOWN LEFT")
            .addCss(dui_light_green, dui_w_full)
            .addClickListener(
                e ->
                    Notification.create("You received a message")
    ...
    Button rotateInOutDownRight =
        Button.create("ROTATE IN OUT DOWN RIGHT")
            .addCss(dui_light_green, dui_w_full)
            .addClickListener(
                e ->
                    Notification.create("You received a message")
    ...
    Button zoomInOutLeft =
        Button.create("ZOOM IN OUT LEFT")
            .addCss(dui_teal, dui_w_full)
            .addClickListener(
                e ->
                    Notification.create("You received a message")
    ...
    Button zoomInOutRight =
        Button.create("ZOOM IN OUT RIGHT")
            .addCss(dui_teal, dui_w_full)
            .addClickListener(
                e ->
                    Notification.create("You received a message")
    ...
    Button zoomInOutDown =
        Button.create("ZOOM IN OUT DOWN")
            .addCss(dui_teal, dui_w_full)
            .addClickListener(
                e ->
                    Notification.create("You received a message")
    ...
    Button lightSpeedInOut =
        Button.create("LIGHT SPEED IN OUT")
    ...
    element.appendChild(
        Card.create("NOTIFICATION ANIMATIONS")
            .appendChild(
                Row.create()
            ...
            .appendChild(Row.create().appendChild(Column.span2().appendChild(lightSpeedInOut)))
            .element());
  }
}
