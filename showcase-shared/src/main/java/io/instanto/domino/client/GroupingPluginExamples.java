...
public final class GroupingPluginExamples implements org.dominokit.domino.ui.style.DominoCss {
  ...
  private void groupingTable() {
    ...
    element.appendChild(
        Card.create(
                "GROUPING PLUGIN",
                "The plugin allows splitting the table data into different groups.")
            .setCollapsible(true)
            .appendChild(table)
            .element());
