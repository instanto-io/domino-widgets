...
public final class ButtonsExamples implements org.dominokit.domino.ui.style.DominoCss {
  ...
  private void initButtons() {
    element.appendChild(
        Card.create("ICON BUTTONS", "Make icon buttons")
            .appendChild(
                Row.create()
                    ...
                    .appendChild(
                        Row.create()
                            .appendChild(
                                Column.span1()
                                    .appendChild(Button.create(Icons.home()).addCss(dui_m_1)))
                            .appendChild(
                                Column.span1()
                                    .appendChild(
                                        Button.create(Icons.home()).addCss(dui_primary, dui_m_1)))
                            .appendChild(
                                Column.span1()
                                    .appendChild(
                                        Button.create(Icons.more()).addCss(dui_info, dui_m_1)))
                            .appendChild(
                                Column.span1()
                                    .appendChild(
                                        Button.create(Icons.keyboard())
                                            .addCss(dui_success, dui_m_1)))
                            .appendChild(
                                Column.span1()
                                    .appendChild(
                                        Button.create(Icons.air_conditioner())
                                            .addCss(dui_warning, dui_m_1)))
                            .appendChild(
                                Column.span1()
                                    .appendChild(
                                        Button.create(Icons.alarm()).addCss(dui_error, dui_m_1)))))
            .appendChild(
                Row.create()
                    ...
                    .appendChild(
                        Row.create()
                            .appendChild(
                                Column.span1()
                                    .appendChild(
                                        Button.create(Icons.circle())
                                            .circle()
                                            .addCss(dui_small, dui_m_1)))
                            .appendChild(
                                Column.span1()
                                    .appendChild(
                                        Button.create(Icons.select_place())
                                            .circle()
                                            .addCss(dui_primary, dui_small, dui_m_1)))
                            .appendChild(
                                Column.span1()
                                    .appendChild(
                                        Button.create(Icons.airplane_off())
                                            .circle()
                                            .addCss(dui_info, dui_small, dui_m_1)))
                            .appendChild(
                                Column.span1()
                                    .appendChild(
                                        Button.create(Icons.album())
                                            .circle()
                                            .addCss(dui_success, dui_small, dui_m_1)))
                            .appendChild(
                                Column.span1()
                                    .appendChild(
                                        Button.create(Icons.calendar_weekend())
                                            .circle()
                                            .addCss(dui_warning, dui_small, dui_m_1)))
                            .appendChild(
                                Column.span1()
                                    .appendChild(
                                        Button.create(Icons.cast_variant())
                                            .circle()
                    ...
                    .appendChild(
                        Row.create()
                            .appendChild(
                                Column.span1()
                                    .appendChild(
                                        Button.create(Icons.adjust())
                                            .circle()
                                            .addCss(dui_large, dui_m_1)))
                            .appendChild(
                                Column.span1()
                                    .appendChild(
                                        Button.create(Icons.microsoft_outlook())
                                            .circle()
                                            .addCss(dui_primary, dui_large, dui_m_1)))
                            .appendChild(
                                Column.span1()
                                    .appendChild(
                                        Button.create(Icons.apps())
                                            .circle()
                                            .addCss(dui_info, dui_large, dui_m_1)))
                            .appendChild(
                                Column.span1()
                                    .appendChild(
                                        Button.create(Icons.account_music())
                                            .circle()
                                            .addCss(dui_success, dui_large, dui_m_1)))
                            .appendChild(
                                Column.span1()
                                    .appendChild(
                                        Button.create(Icons.assistant())
                                            .circle()
                                            .addCss(dui_warning, dui_large, dui_m_1)))
                            .appendChild(
                                Column.span1()
                                    .appendChild(
                                        Button.create(Icons.compass())
                                            .circle()
  ...
  private void initTextButtons() {
    element.appendChild(
        Card.create("ICON & TEXT BUTTONS", "Make icon & text buttons")
            .appendChild(Button.create(Icons.widgets(), "EXTENSION").addCss(dui_m_1))
            .appendChild(Button.create(Icons.home(), "Home").addCss(dui_m_1).setReversed(true))
            .appendChild(Button.create(Icons.home(), "Home").addCss(dui_primary, dui_m_1))
            .appendChild(Button.create(Icons.lock(), "LOCK").addCss(dui_accent, dui_m_1))
            .element());
  }
  ...
  private void initButtonsToolbar() {
    element.appendChild(
        Card.create("BUTTON TOOLBAR", "Create buttons toolbar")
            .appendChild(
                Row.create()
                    .appendChild(
                        Column.span3()
                            ...
                            .appendChild(
                                ButtonsToolbar.create()
                                    .appendChild(
                                        ButtonsGroup.create()
                                            .appendChild(
                                                Button.create("1").addCss(dui_purple, dui_fg_white))
                                            .appendChild(
                                                Button.create("2").addCss(dui_purple, dui_fg_white))
                                            .appendChild(
                                                Button.create("3")
                                                    .addCss(dui_purple, dui_fg_white)))
                                    .appendChild(
                                        ButtonsGroup.create()
                                            .appendChild(
                                                Button.create("4").addCss(dui_purple, dui_fg_white))
                                            .appendChild(
                                                Button.create("5").addCss(dui_purple, dui_fg_white))
                                            .appendChild(
                                                Button.create("6")
                                                    .addCss(dui_purple, dui_fg_white)))
                                    .appendChild(
  ...
  private void initSizingGroup() {
    ...
    element.appendChild(
        Card.create(
                "SIZING",
                "Instead of applying button sizing classes to every button in a group, size can be"
                    + " applied to the group and will be applied to every button.")
            .appendChild(
                Row.create()
                    .appendChild(
                        Column.span3()
  ...
  private void initNestingGroup() {
    element.appendChild(
        Card.create("SIZING", "Dropdown can be used inside a group of buttons.")
            .appendChild(
                ButtonsGroup.create()
                    .appendChild(Button.create("1"))
                    .appendChild(Button.create("2"))
  ...
  private void initSplitButton() {
    element.appendChild(
        Card.create(
                ...
                "Similarly, create split button dropdowns with the same markup changes, only with a"
                    + " separate button.")
            .appendChild(
                ButtonsGroup.create(
  ...
  private void initDropDownPosition() {
    element.appendChild(
        Card.create("DROPUP VARIATION", "Trigger dropdown menus above elements.")
            .appendChild(
                DropdownButton.create(
  ...
  private HeadingElement heading(String content) {
    return h(2).textContent(content).addCss(dui_m_t_6, dui_font_size_4);
  }
}
