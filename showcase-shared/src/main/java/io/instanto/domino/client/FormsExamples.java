...
public final class FormsExamples implements org.dominokit.domino.ui.style.DominoCss {
  ...
  private static final org.dominokit.domino.ui.utils.ElementsFactory elements =
      org.dominokit.domino.ui.utils.ElementsFactory.elements;
      ...
      super(
          ...
          (key, value) ->
              elements
                  .div()
                  .appendChild(
                      LabeledIcon.create(mdiIcon.copy(), mdiIcon.getName())
                          .addCss(dui_rounded_full, dui_accent, dui_p_x_1)),
          (key, icon) ->
              CustomMenuItem.<MdiIcon>create()
                  .setSearchFilter(
                      (token, caseSensitive) ->
                          icon.getMetaInfo().getAliases().stream()
                              ...
                              || icon.getMetaInfo().getTags().stream()
                                  .anyMatch(iconTag -> compare(iconTag, token, caseSensitive)))
                  .appendChild(
                      elements
                          .div()
                          ...
                          .appendChild(mdiIcon)
                          .appendChild(
                              elements.span().addCss(dui_grow_1).textContent(mdiIcon.getName()))
                          .appendChild(
                              Badge.create("version :" + mdiIcon.getMetaInfo().getVersion())
                    ...
                    .appendChild(
                        Column.span12()
                            ...
                            .appendChild(
                                RadioGroup.<String>create("test")
                                    .appendChild(
                                        Radio.create("radio1_gap", "Radio 1 - With Gap")
                                            .setReadOnly(true))
                        ...
                        Column.span12()
                            ...
                            .appendChild(
                                RadioGroup.<String>create("test")
                                    .disable()
                                    .appendChild(
                                        Radio.create("radio1_disabled", "Radio 1 - Disabled")
                                            .disable()
                                            .check())
                                    .appendChild(
                                        Radio.create("radio2_disabled", "Radio 2 - Disabled")
                                            .disable())
                                    .appendChild(
                                        Radio.create("radio3_disabled", "Radio 3 - Disabled")
                                            .disable())
                                    .horizontal()))
                    .appendChild(
                        Column.span12()
            ...
            .appendChild(
                Row.create()
                    ...
                    .appendChild(
                        Column.span3()
                            .appendChild(
                                RadioGroup.<String>create("AMBER")
                                    .addCss(dui_accent_amber)
                                    .appendChild(Radio.create("Radio 1", "Radio 1"))
                                    .appendChild(Radio.create("Radio 2", "Radio 2"))
                                    .appendChild(Radio.create("Radio 3", "Radio 3"))))
                    .appendChild(
                        Column.span3()
                            .appendChild(
                                RadioGroup.<String>create("ACCENT")
                                    .appendChild(Radio.create("Radio 1", "Radio 1"))
                                    .appendChild(Radio.create("Radio 2", "Radio 2"))
                                    .appendChild(Radio.create("Radio 3", "Radio 3"))))
                    .appendChild(
            ...
            .appendChild(
                Row.create()
                    .appendChild(
                        Column.span3()
                            .appendChild(
                                SwitchButton.create("Active", "off", "on")
                                    .addChangeListener(
                                        (oldValue, value) ->
                                            Notification.create("test " + value)
                                                .addCss(dui_info)
                                                .show())
                                    .setOffTitle("OFF")
                                    .setOnTitle("ON")))
                        ...
                        Column.span6()
                            .appendChild(
                                Select.<String>create()
                                    .appendChild(
                                        SelectOption.create("nothing", null, "-- please select --"))
                    ...
                    .appendChild(
                        Column.span6()
                            .appendChild(
                                Select.<String>create()
                                    .appendChild(
                                        SelectOption.create("Disabled", "Disabled", "Disabled"))
                                    .selectAt(0)
                                    .disable())))
            ...
            .appendChild(
                Row.create()
                    .appendChild(
                        Column.span6()
                            .appendChild(
                                Select.<String>create("Country")
                                    .setSearchable(true)
                                    .setMissingItemHandler(
                                        (select, token, onComplete) -> {
                                          TextBox countryName =
                                              TextBox.create("Name")
                                                  .setRequired(true)
                                                  .withValue(token);
                                          TextBox countryCode =
                                              TextBox.create("code").setRequired(true);
                ...
                Row.create()
                            ...
                            .appendChild(
                                Select.<String>create("Country")
                                        ...
                                        group -> {
                                          group.withHeader(
                                              (parent, header) ->
                                                  header
                                                      .appendChild(
                                                          PrefixAddOn.of(Icons.map_marker()))
                                                      .appendChild(
                                                          PostfixAddOn.of(
                                                              Badge.create("5")
                                                                  .addCss(
                                    ...
                                    .group(
                                        ...
                                        Arrays.asList(
                                            SelectOption.create("FRA", "FRA", "France"),
                    ...
                    .appendChild(
                        Column.span6()
                            ...
                            .appendChild(
                                Select.<MdiIcon>create("Icon picker")
                                    .appendItems(
                                        IconOption::create,
                                        Icons.access_point(),
                                    ...
                                    .addChangeListener(
                                        (oldValue, newValue) -> {
                                          Notification.create(
                                                  "Item selected [ " + newValue.getName() + " ]")
                ...
                Row.create()
                    .appendChild(
                        Column.span6()
                            ...
                            .appendChild(
                                MultiSelect.<String>create("Country")
                                    .appendChild(SelectOption.create("USA", "USA", "America (USA)"))
                                    .appendChild(SelectOption.create("ARG", "ARG", "Argentina"))
                                    .appendChild(SelectOption.create("BRA", "BRA", "Brazil"))
                                    .appendChild(SelectOption.create("DEN", "DEN", "Denmark"))
                    ...
                    .appendChild(
                        Column.span6()
                            .appendChild(BlockHeader.create("Multi select"))
                            .appendChild(
                                MultiSelect.<MdiIcon>create("Icon picker")
                                    .appendItems(
                                        IconOption::create,
                                        Icons.access_point(),
                                        IconsMeta.access_point_check(),
