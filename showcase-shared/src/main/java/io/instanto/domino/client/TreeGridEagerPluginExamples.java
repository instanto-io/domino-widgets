...
public final class TreeGridEagerPluginExamples implements org.dominokit.domino.ui.style.DominoCss {
  ...
  private void treeGridFullParentSpan() {
                    ...
                    config -> {
                      config
                          ...
                          .setParentRowCellsSupplier(
                              (dataTable, tableRow) -> {
                                TDElement cellElement =
                                    td().addCss(dui_datatable_td).setAttribute("colspan", "8");
                                RowCell<Contact> rowCell =
                                    new RowCell<>(
                                        new org.dominokit.domino.ui.datatable.RowCellInfo<>(
                                            tableRow, cellElement.element()),
    ...
    element.appendChild(
        Card.create(
                "TREE GRID PLUGIN - Full PARENT SPAN",
  ...
  private void treeGridParentColumns() {
    ...
    element.appendChild(
        Card.create(
                "TREE GRID PLUGIN - PARENT WITH COLUMNS",
                "Render records in tree style with expand and collapse features")
            .setCollapsible(true)
            .appendChild(table)
            .element());
