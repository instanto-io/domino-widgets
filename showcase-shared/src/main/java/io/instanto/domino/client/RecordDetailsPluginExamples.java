...
public final class RecordDetailsPluginExamples implements org.dominokit.domino.ui.style.DominoCss {
  ...
  private void recordDetailsPlugin() {
    ...
    element.appendChild(
        Card.create("RECORD DETAILS PLUGIN", "Enable inline record details for rows.")
            .setCollapsible(true)
