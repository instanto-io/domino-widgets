...
public final class EditableDataTableExamples implements org.dominokit.domino.ui.style.DominoCss {
  ...
  private void editableTable() {
    ...
    tableConfig
        .addColumn(
            ColumnConfig.<Contact>create("edit_save", "")
                .setCellRenderer(
                    cell ->
                        Icons.pencil()
                            .clickable()
                ...
                .setEditableCellRenderer(
                    cell -> {
                      ...
                      cell.setDirtyRecordHandler(
                          dirty -> dirty.setActive(activeCheckBox.getValue()));
        ...
        .addColumn(
            ColumnConfig.<Contact>create("firstName", "First name")
                ...
                .setEditableCellRenderer(
                    cell -> {
                      TextBox nameBox = TextBox.create().withValue(cell.getRecord().getName());
        ...
        .addColumn(
            ColumnConfig.<Contact>create("eyeColor", "Eye color")
                ...
                .setEditableCellRenderer(
                    cell -> {
                      Select<EyeColor> eyeColorSelect =
                          Select.<EyeColor>create()
                      ...
                      cell.setDirtyRecordHandler(
                          dirty -> dirty.setEyeColor(eyeColorSelect.getValue()));
        ...
        .addColumn(
            ColumnConfig.<Contact>create("email", "Email")
                ...
                .setEditableCellRenderer(
                    cell -> {
                      EmailBox emailBox = EmailBox.create().withValue(cell.getRecord().getEmail());
                ...
                .setEditableCellRenderer(
                    cell -> {
                      TelephoneBox telephoneBox =
                          TelephoneBox.create().withValue(cell.getRecord().getPhone());
    ...
    element.appendChild(
        Card.create("EDITABLE TABLE", "Render cells as editable fields and save the row data.")
            .setCollapsible(true)
            .appendChild(table)
            .element());
