...
public final class SlidersExamples implements org.dominokit.domino.ui.style.DominoCss {
  ...
  private void initBasic() {
    basicCard
        .appendChild(
            Row.create()
                .appendChild(Column.span12().appendChild(BlockHeader.create("SIMPLE SLIDERS"))))
        .appendChild(
            Row.create()
                .appendChild(
                    Column.span12()
                        .appendChild(
                            Slider.create(200)
                                .setShowThumb(true)
                                .addChangeListener(
                                    (oldValue, newValue) -> showNotification(newValue)))))
        .appendChild(Row.create().appendChild(Column.span12().appendChild(hr())))
        .appendChild(
            Row.create()
                .appendChild(Column.span12().appendChild(BlockHeader.create("SLIDERS WITH THUMB"))))
        .appendChild(
            Row.create()
                .appendChild(
                    Column.span12()
                        .appendChild(
                            Slider.create(200, 20)
                                .setValue(50)
                                .setReadOnly(true)
                                .withThumb()
                                .addChangeListener(
        ...
        .appendChild(
            Row.create()
                .appendChild(
                    Column.span12()
                        .appendChild(
                            BlockHeader.create("SLIDERS CAN HAVE MIN AND MAX VALUES")
        ...
        .appendChild(
            Row.create()
                .appendChild(
                    Column.span12()
                        .appendChild(
                            BlockHeader.create("SLIDERS WITH STEP")
                                .appendChild(span().textContent("MIN: 100").element())
                                .appendChild(br().element())
                                .appendChild(span().textContent("MAX: 200").element())
                                .appendChild(br().element())
        ...
        .appendChild(
            Row.create()
                .appendChild(
                    Column.span12()
                        .appendChild(
                            BlockHeader.create("SLIDERS WITH ANY STEP")
                                .appendChild(span().textContent("MIN: 100").element())
                                .appendChild(br().element())
                                .appendChild(span().textContent("MAX: 200").element())
                                .appendChild(br().element())
  ...
  private void initColors() {
    colorsSlidersCard
        .appendChild(
            Row.create()
                .appendChild(Column.span4().appendChild(Slider.create(100).addCss(dui_accent_red)))
                .appendChild(
                    Column.span4()
                        .appendChild(
                            Slider.create(100)
                                ...
                                .withThumb(
                                    (parent, thumb) -> thumb.addCss(dui_bg_red_d_2, dui_fg))))
                .appendChild(
                    Column.span4()
                        .appendChild(
                            Slider.create(100)
        ...
        .appendChild(
            Row.create()
                .appendChild(
                    Column.span4().appendChild(Slider.create(100).addCss(dui_accent_green)))
                .appendChild(
                    Column.span4()
                        .appendChild(
                            Slider.create(100)
                                ...
                                .withThumb(
                                    (parent, thumb) -> thumb.addCss(dui_bg_green_d_2, dui_fg))))
                .appendChild(
                    Column.span4()
                        .appendChild(
                            Slider.create(100)
        ...
        .appendChild(
            Row.create()
                .appendChild(Column.span4().appendChild(Slider.create(100).addCss(dui_accent_blue)))
                .appendChild(
                    Column.span4()
                        .appendChild(
                            Slider.create(100)
                                ...
                                .withThumb(
                                    (parent, thumb) -> thumb.addCss(dui_bg_blue_d_2, dui_fg))))
                .appendChild(
                    Column.span4()
                        .appendChild(
                            Slider.create(100)
        ...
        .appendChild(
            Row.create()
                .appendChild(
                    Column.span4().appendChild(Slider.create(100).addCss(dui_accent_purple)))
                .appendChild(
                    Column.span4()
                        .appendChild(
                            Slider.create(100)
                                ...
                                .withThumb(
                                    (parent, thumb) -> thumb.addCss(dui_bg_purple_d_2, dui_fg))))
                .appendChild(
                    Column.span4()
                        .appendChild(
                            Slider.create(100)
        ...
        .appendChild(
            Row.create()
                .appendChild(
                    Column.span4().appendChild(Slider.create(100).addCss(dui_accent_orange)))
                .appendChild(
                    Column.span4()
                        .appendChild(
                            Slider.create(100)
                                ...
                                .withThumb(
                                    (parent, thumb) -> thumb.addCss(dui_bg_orange_d_2, dui_fg))))
                .appendChild(
                    Column.span4()
                        .appendChild(
                            Slider.create(100)
        ...
        .appendChild(
            Row.create()
                .appendChild(Column.span4().appendChild(Slider.create(100).addCss(dui_accent_cyan)))
                .appendChild(
                    Column.span4()
                        .appendChild(
                            Slider.create(100)
                                ...
                                .withThumb(
                                    (parent, thumb) -> thumb.addCss(dui_bg_cyan_d_2, dui_fg))))
                .appendChild(
                    Column.span4()
                        .appendChild(
                            Slider.create(100)
  ...
  private void initExample() {
    DivElement rgbColorsDiv = div().addCss(dui_h_full, dui_w_full);

    Slider redSlider = Slider.create(255, 0).addCss(dui_accent_red).anyStep().setShowThumb(false);
    Slider greenSlider =
        Slider.create(255, 0).addCss(dui_accent_green).anyStep().setShowThumb(false);
    ;
    Slider blueSlider = Slider.create(255, 0).addCss(dui_accent_blue).anyStep().setShowThumb(false);
    ;
  ...
  private void updateBackgroundColor(
      DivElement rgbColorsDiv, Slider redSlider, Slider greenSlider, Slider blueSlider) {
    rgbColorsDiv.setBackgroundColor(
        "rgb("
            + redSlider.getValue()
            + ", "
  ...
  private void updateColorAndTextBoxes(
      DivElement rgbColorsDiv,
      Slider redSlider,
      Slider greenSlider,
      Slider blueSlider,
      TextBox redTextBox,
