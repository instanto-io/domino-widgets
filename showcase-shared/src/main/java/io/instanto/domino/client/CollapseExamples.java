...
public final class CollapseExamples implements org.dominokit.domino.ui.style.DominoCss {
  ...
  private void example() {
    ...
    DivElement heightDiv =
        div()
            .addCss(dui_h_24, dui_m_y_4)
            .appendChild(div().addCss(dui_accent, dui_p_4).textContent(SAMPLE_CONTENT));
    ...
    DivElement animationDiv =
        div()
            .addCss(dui_h_24, dui_m_y_4)
            .appendChild(div().addCss(dui_accent, dui_p_4).textContent(SAMPLE_CONTENT));

    Collapsible heightCollapsible =
        Collapsible.create(heightDiv)
            .setStrategy(new HeightCollapseStrategy(CollapsibleDuration._300ms));

    Collapsible displayCollapsible =
        Collapsible.create(displayDiv).setStrategy(new DisplayCollapseStrategy());

    Collapsible animationCollapsible =
        Collapsible.create(animationDiv)
            .setStrategy(
                new AnimationCollapseStrategy(
                    Transition.FADE_IN, Transition.FADE_OUT, CollapsibleDuration._500ms));

    Button heightCollapseButton = Button.create("Height collapse");
    heightCollapseButton
        .getClickableElement()
        .addEventListener("click", evt -> heightCollapsible.toggleCollapse());

    Button displayCollapseButton = Button.create("Display collapse");
    displayCollapseButton
        .getClickableElement()
        .addEventListener("click", evt -> displayCollapsible.toggleCollapse());

    Button animationCollapseButton = Button.create("Animation collapse");
    animationCollapseButton
        .getClickableElement()
        .addEventListener("click", evt -> animationCollapsible.toggleCollapse());
                        ...
                        Card.create(
                            ...
                            .appendChild(
                                Row.create()
                                    .appendChild(
                                        Column.span12()
                                            .appendChild(heightCollapseButton.addCss(dui_accent))
                                            .appendChild(heightDiv)))
                            .appendChild(
                                Row.create()
                                    .appendChild(
                                        Column.span12()
                                            .appendChild(displayCollapseButton.addCss(dui_accent))
                                            .appendChild(displayDiv)))
                            .appendChild(
                                Row.create()
                                    .appendChild(
                                        Column.span12()
                                            .appendChild(animationCollapseButton.addCss(dui_accent))
            ...
            .appendChild(
                Column.span6()
                    .appendChild(
                        Card.create(
                                "BASIC EXAMPLES",
                                "Extend the default collapse behavior to create an accordion with"
                                    + " the panel component.")
                            .setCollapsible(true)
                                ...
                                Accordion.create()
                                        ...
                                        AccordionPanel.create("Collapsible item 1")
                                            .withHeader(
                                                (parent, header) ->
                                                    header
                                                        .appendChild(
                                                            PrefixAddOn.of(Icons.bus_clock()))
                                                        .appendChild(
                                                            PostfixAddOn.of(
                                                                Badge.create("15")
                                                                    .addCss(
                                                                        ...
                                                                        dui_bg_accent_d_3)))
                                                        .appendChild(
                                                            PostfixAddOn.of(Icons.clock_end())))
                                            .withContentHeader(
                                            ...
                                            .withContentFooter(
                                                (parent, footer) ->
                                                    footer
                                                        ...
                                                        .appendChild(
                                                            PostfixAddOn.of(
                                                                LinkButton.create("Remove")))
                                                        .appendChild(
                                                            PostfixAddOn.of(
                                                                Button.create("Accept")
                                                                    .addCss(
                                                                        dui_success, dui_w_28))))
                                    ...
                                    .appendChild(
                                        AccordionPanel.create("Collapsible item 2")
                                            ...
                                            .appendChild(text(SAMPLE_CONTENT)))
                                    .appendChild(
                                        AccordionPanel.create("Collapsible item 3")
                                            .withHeader(
                                                (parent, header) ->
                                                    header
                                                        .appendChild(
                            ...
                            .appendChild(
                                Accordion.create()
                                    .addCss(
                                        dui_primary, dui_ignore_bg, dui_ignore_fg, dui_rounded_md)
                                    .appendChild(
                                        AccordionPanel.create("Collapsible item 1")
                                            .withHeader(
                                                (parent, header) ->
                            ...
                            .appendChild(
                                Accordion.create()
                                    .addCss(dui_orange, dui_ignore_bg, dui_ignore_fg)
                                    .appendChild(
                                        AccordionPanel.create("Collapsible item 1")
                                            .withHeader(
                                                (parent, header) ->
                            ...
                            .appendChild(
                                Accordion.create()
                                    .addCss(dui_teal, dui_ignore_bg, dui_ignore_fg)
                                    .appendChild(
                                        AccordionPanel.create("Collapsible item 1")
                                            .withHeader(
                                                (parent, header) ->
            ...
            .appendChild(
                Column.span6()
                    .appendChild(
                        Card.create(
                                "FULL BODY EXAMPLES",
                                "If you want to also colorful body, you need to use fullBody"
                                    + " method.")
                            .setCollapsible(true)
                            .appendChild(b().textContent("Panel Accent"))
                            .appendChild(
                            ...
                            .appendChild(
                                Accordion.create()
                                    .addCss(dui_primary, dui_rounded_lg)
                                    .appendChild(
                                        AccordionPanel.create("Collapsible item 1")
                                            .withHeader(
                                                (parent, header) ->
    ...
    element.appendChild(
        Row.create()
            .appendChild(
                Column.span6()
                    .appendChild(
                        Card.create("COLORFUL PANEL ITEMS WITH ICON")
                            .setCollapsible(true)
                            .appendChild(b().textContent("Panel Primary"))
                            .appendChild(
                                Accordion.create()
                                    ...
                                    .appendChild(
                                        AccordionPanel.create("Collapsible item 3")
                                            ...
                                            .appendChild(text(SAMPLE_CONTENT)))
                                    .appendChild(
                                        AccordionPanel.create("Collapsible item 4")
                                            .withHeader(
                                                (parent, header) ->
                                                    header
                                                        .addCss(dui_orange)
            ...
            .appendChild(
                Column.span6()
                    .appendChild(
                        Card.create("FULL BODY COLORFUL PANEL ITEMS WITH ICON")
                            .setCollapsible(true)
                            .appendChild(b().textContent("Panel Accent"))
                            .appendChild(
                                Accordion.create()
                                                            ...
                                                            PostfixAddOn.of(
                                                                Button.create("Accept")
                                                                    .addCss(
                                                                        dui_success, dui_w_28))))
                                            .withContent(
                                                (parent, content) -> content.addCss(dui_accent))
                                            .appendChild(text(SAMPLE_CONTENT))
                                            .expand())
                                    .appendChild(
                                        AccordionPanel.create("Collapsible item 2")
                                                            ...
                                                            PostfixAddOn.of(
                                                                Button.create("Accept")
                                                                    .addCss(
                                                                        dui_success, dui_w_28))))
                                            .withContent(
                                                (parent, content) -> content.addCss(dui_primary))
                                            .appendChild(text(SAMPLE_CONTENT)))
                                    .appendChild(
                                        AccordionPanel.create("Collapsible item 3")
                                            .withHeader(
                                                            ...
                                                            PostfixAddOn.of(
                                                                Button.create("Accept")
                                                                    .addCss(
                                                                        dui_success, dui_w_28))))
                                            .withContent(
                                                (parent, content) -> content.addCss(dui_teal))
                                            .appendChild(text(SAMPLE_CONTENT)))
                                    .appendChild(
                                        AccordionPanel.create("Collapsible item 4")
                                            .withHeader(
                                            ...
                                            .withContent(
                                                (parent, content) ->
                                                    content.addCss(dui_deep_orange))
                                            .appendChild(text(SAMPLE_CONTENT)))))));
  }
    ...
    element.appendChild(
        Row.create()
            .appendChild(
                Column.span12()
                    .appendChild(
                        Card.create("MULTIPLE ITEMS TO BE OPEN")
                            .setCollapsible(true)
                            .appendChild(
                                Accordion.create()
                                    .setMultiOpen(true)
