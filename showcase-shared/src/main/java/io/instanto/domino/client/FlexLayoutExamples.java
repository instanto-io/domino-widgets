...
public final class FlexLayoutExamples implements org.dominokit.domino.ui.style.DominoCss {
  private final DivElement element = div();
  private Card layoutPlaygroundCard = Card.create("LAYOUT PLAYGROUND");
  private Card flexItemsCard = Card.create("FLEX ITEMS");
  ...
  private void initLayoutPlayground() {
    ...
    LimitOneOfCssClass directionCss =
        LimitOneOfCssClass.of(
            dui_flex_row, dui_flex_row_reverse, dui_flex_col, dui_flex_col_reverse);

    LimitOneOfCssClass wrapCss =
        LimitOneOfCssClass.of(dui_flex_wrap, dui_flex_wrap_reverse, dui_flex_nowrap);

    LimitOneOfCssClass justifyContentCss =
        LimitOneOfCssClass.of(
            dui_justify_start,
            dui_justify_end,
            dui_justify_center,
    ...
    LimitOneOfCssClass alignItemsCss =
        LimitOneOfCssClass.of(
            dui_items_start,
            dui_items_end,
            dui_items_center,
                    ...
                    Column.span6()
                        .appendChild(
                            directionsRadioGroup
                                .setHelperText(
                                    "Containers inside Flex Layout can have different directions")
                                .setLabel("Directions")
                    ...
                    Column.span6()
                        .appendChild(
                            wrapRadioGroup
                                ...
                                .appendChild(
                                    Radio.create(dui_flex_wrap_reverse, "Wrap bottom to top"))
                                .horizontal())))
        .appendChild(
            Row.create()
                .appendChild(
                    Column.span6()
                        .appendChild(
                            justifyContentRadioGroup
                                .setHelperText(
                                    "Containers inside Flex Layout can be placed in different ways")
                ...
                .appendChild(
                    Column.span6()
                        .appendChild(
                            alignItemsRadioGroup
                                .setHelperText(
                                    "Containers inside Flex Layout can be aligned in different"
                                        + " ways")
    ...
    // ********* flex layout part ********* //
    DivElement flexLayout =
        div()
            .addCss(dui_flex, dui_flex_row, dui_h_full, dui_items_start, dui_gap_4)
            .setCssProperty("counter-reset", "section")
            .appendChild(div().addCss(() -> "demo-flex-layout-block").appendChild(h(4)))
            .appendChild(div().addCss(() -> "demo-flex-layout-block").appendChild(h(4)))
            .appendChild(div().addCss(() -> "demo-flex-layout-block").appendChild(h(4)));

    layoutPlaygroundCard.appendChild(
        div().addCss(dui_h_96, dui_bg_accent).appendChild(flexLayout).element());

    // ********* listeners part ********* //
    directionsRadioGroup.addChangeListener(
        (old, direction) -> flexLayout.addCss(directionCss.use(direction)));

    justifyContentRadioGroup.addChangeListener(
        (old, justify) -> flexLayout.addCss(justifyContentCss.use(justify)));

    alignItemsRadioGroup.addChangeListener(
        (old, align) -> flexLayout.addCss(alignItemsCss.use(align)));
    ...
    addBlockButton.addClickListener(
        evt -> {
          DivElement item = div().addCss("demo-flex-layout-block").appendChild(h(4));
  ...
  private void initFlexItems() {
    ...
    TextBox flexBasisTextBox =
        TextBox.create("Flex Basis")
            .setHelperText("Default size of an element before the remaining space is distributed");
    RadioGroup<String> targetBlockRadioGroup =
        RadioGroup.create("target-block", "Target block # to play with");
    RadioGroup<CssClass> alignSelfRadioGroup = RadioGroup.create("align-self", "Align self");

    LimitOneOfCssClass alignSelfCss =
        LimitOneOfCssClass.of(
            dui_self_start, dui_self_end, dui_self_center, dui_self_stretch, dui_self_baseline);
    ...
    flexGrowSlider.addChangeListener(
        (old, value) ->
            items
                .get(targetBlockRadioGroup.getValue())
    ...
    flexShrinkSlider.addChangeListener(
        (old, value) ->
            items
                .get(targetBlockRadioGroup.getValue())
    ...
    alignSelfRadioGroup.addChangeListener(
        (old, value) ->
            items.get(targetBlockRadioGroup.getValue()).addCss(alignSelfCss.use(value)));

    flexBasisTextBox.addChangeListener(
        (old, value) ->
            items
                .get(targetBlockRadioGroup.getValue())
    ...
    targetBlockRadioGroup.addChangeListener(
        (old, value) -> {
          ...
          flexShrinkSlider.setValue(
              Double.parseDouble(flexItem.getAttribute("dui-demo-shrink", "0")));
          flexBasisTextBox.setValue(flexItem.getAttribute("dui-demo-basis", "auto"));
          alignSelfCss.getActive(flexItem.element()).ifPresent(alignSelfRadioGroup::setValue);
        });
